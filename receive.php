<?php
    ...
    if(isset($_POST['ok'])){
        ...
        $in = $db->query("INSERT INTO donor SET institution = '$donation_center', name = '$name', email = '$email', phone = '$phone', blood_group = '$blood_group', donation_date = '$donation_date', donation_time = '$donation_time', o_type = 'receiver'");

        set_flash("Your request has been submitted successfully!!! We will get back to you","success");
...
<!--[if !IE]><!--> <html lang="en"> <!--<![endif]-->
    ...
    <head>
        <title>Student Blood Bank - Receive Blood</title>
            ...
            <div class="container wow fadeInUp">
                ...
                <div class="row section-heading-wrapper">
                    ...
                    <div class="col-md-12 col-sm-12 text-center">
                        <h2 class="section-heading">Receive Blood</h2>
                        <p class="section-subheading">Submit a request to receive blood</p>
                    </div> <!-- end .col-sm-10  -->
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="appointment-form-wrapper text-center clearfix">
                            <h3 class="join-heading">Request for Blood</h3>
